...
/* The site's own plugin order up to this point: gfm attached after
   remark-rehype, raw HTML parsed before the notes run */
...
test("a note that cites another note carries that note's mark, and never itself", () => {
  ...
  /* The self-citation stays remark's link rather than opening forever */
