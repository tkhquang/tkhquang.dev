 ...
 *
 * Generated at: 2025-11-07T02:00:17.087Z
 *
 * To modify: Edit ../../assets/styles/index.css
...
export interface DefaultTheme {
  ...
  black: '#000';
  white: '#fff';
  theme: { background: { DEFAULT: 'var(--background)'; dark: 'hsl(200deg 50% 15%)'; light: 'hsl(220deg 50% 95%)' }; code: { DEFAULT: 'var(--code)'; dark: 'rgb(0 0 0 / 8%)'; light: 'rgb(0 0 0 / 8%)' }; darken: { DEFAULT: 'var(--darken)'; dark: 'color-mix(in srgb, black 80%, hsl(200deg 50% 15%))'; light: 'color-mix(in srgb, black 80%, hsl(220deg 50% 95%))' }; error: { DEFAULT: 'var(--error)'; dark: 'hsl(360deg 50% 70%)'; light: 'hsl(360deg 50% 40%)' }; on: { background: { DEFAULT: 'var(--on-background)'; dark: 'hsl(200deg 50% 80%)'; light: 'hsl(220deg 40% 30%)' }; primary: { DEFAULT: 'var(--on-primary)'; dark: 'hsl(200deg 50% 10%)'; light: 'hsl(220deg 50% 95%)' }; secondary: { DEFAULT: 'var(--on-secondary)'; dark: 'hsl(200deg 20% 85%)'; light: 'hsl(220deg 45% 20%)' }; surface: { DEFAULT: 'var(--on-surface)'; dark: 'hsl(200deg 50% 85%)'; light: 'hsl(220deg 50% 35%)' } }; primary: { DEFAULT: 'var(--primary)'; dark: 'hsl(200deg 50% 70%)'; light: 'hsl(220deg 50% 50%)' }; secondary: { DEFAULT: 'var(--secondary)'; dark: 'hsl(200deg 60% 25%)'; light: 'hsl(220deg 45% 75%)' }; success: { DEFAULT: 'var(--success)'; dark: 'hsl(120deg 50% 60%)'; light: 'hsl(120deg 50% 40%)' }; surface: { DEFAULT: 'var(--surface)'; dark: 'hsl(200deg 50% 18%)'; light: 'hsl(220deg 50% 90%)' }; tone: { '1': 'hsl(220deg 100% 50%)'; '2': 'hsl(200deg 100% 50%)'; '3': 'hsl(360deg 100% 50%)'; DEFAULT: 'var(--tone)' } }
};
  fontSize: {
  ...
  fonts: {
  sans: '[object Object]';
  serif: '"Merriweather", "Merriweather Fallback", georgia, cambria,\n    "Times New Roman", times, serif';
  mono: '"Source Code Pro", "Source Code Pro Fallback", ui-monospace, sfmono-regular,\n    menlo, monaco, consolas, "Liberation Mono", "Courier New", monospace'
};
  fontWeight: {
  thin: '100';
  extralight: '200';
...
export interface Light {
  colors: {
  theme: { background: { DEFAULT: 'hsl(220deg 50% 95%)'; dark: 'hsl(200deg 50% 15%)'; light: 'hsl(220deg 50% 95%)' }; code: { DEFAULT: 'rgb(0 0 0 / 8%)'; dark: 'rgb(0 0 0 / 8%)'; light: 'rgb(0 0 0 / 8%)' }; darken: { DEFAULT: 'color-mix(in srgb, black 80%, hsl(220deg 50% 95%))'; dark: 'color-mix(in srgb, black 80%, hsl(200deg 50% 15%))'; light: 'color-mix(in srgb, black 80%, hsl(220deg 50% 95%))' }; error: { DEFAULT: 'hsl(360deg 50% 40%)'; dark: 'hsl(360deg 50% 70%)'; light: 'hsl(360deg 50% 40%)' }; on: { background: { DEFAULT: 'hsl(220deg 40% 30%)'; dark: 'hsl(200deg 50% 80%)'; light: 'hsl(220deg 40% 30%)' }; primary: { DEFAULT: 'hsl(220deg 50% 95%)'; dark: 'hsl(200deg 50% 10%)'; light: 'hsl(220deg 50% 95%)' }; secondary: { DEFAULT: 'hsl(220deg 45% 20%)'; dark: 'hsl(200deg 20% 85%)'; light: 'hsl(220deg 45% 20%)' }; surface: { DEFAULT: 'hsl(220deg 50% 35%)'; dark: 'hsl(200deg 50% 85%)'; light: 'hsl(220deg 50% 35%)' } }; primary: { DEFAULT: 'hsl(220deg 50% 50%)'; dark: 'hsl(200deg 50% 70%)'; light: 'hsl(220deg 50% 50%)' }; secondary: { DEFAULT: 'hsl(220deg 45% 75%)'; dark: 'hsl(200deg 60% 25%)'; light: 'hsl(220deg 45% 75%)' }; success: { DEFAULT: 'hsl(120deg 50% 40%)'; dark: 'hsl(120deg 50% 60%)'; light: 'hsl(120deg 50% 40%)' }; surface: { DEFAULT: 'hsl(220deg 50% 90%)'; dark: 'hsl(200deg 50% 18%)'; light: 'hsl(220deg 50% 90%)' }; tone: { '1': 'hsl(220deg 100% 50%)'; '2': 'hsl(200deg 100% 50%)'; '3': 'hsl(360deg 100% 50%)'; DEFAULT: 'hsl(220deg 100% 50%)' } }
};
  fonts: {
  sans: '[object Object]';
  serif: '"Merriweather", "Merriweather Fallback", georgia, cambria,\n    "Times New Roman", times, serif';
