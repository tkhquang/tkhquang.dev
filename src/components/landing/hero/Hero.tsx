...
const Hero = () => {
  return (
    <section className="flex-center relative min-h-[600px] animate-hero-height overflow-hidden text-theme-on-primary-light before:pointer-events-none before:absolute before:inset-x-0 before:top-0 before:block before:h-full before:min-h-screen before:bg-gradient-to-br before:from-theme-tone before:to-theme-on-background-light before:content-['']">
