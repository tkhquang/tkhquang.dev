...
const BlogHeader = ({
  ...
  return (
    <header
      {...props}
      className={clsx(
        "site-header band--day h-header-height sticky inset-0 z-(--z-header) m-0 w-full p-0 transition-[background-color,color,box-shadow] duration-300",
        transparent
    ...
    >
      <div className="site-header__inner container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div
          className={clsx(
            "header__left site-header__identity transition-opacity duration-300",
        ...
        >
          <button
            type="button"
            className="site-header__brand site-header__brand--blog logo"
            aria-label={
              isHomeBlog ? "Back to the top of the blog" : "Back to the blog"
            }
            onClick={handleLogoClick}
          >
            {!isHomeBlog && (
              <BackButtonIcon className="site-header__back" aria-hidden />
            )}
            <span className="site-header__signature">
              <PersonalMark />
              <span
          ...
          <Link
            href="/"
            className="site-header__byline"
            aria-label="Aleks's portfolio"
            title="Visit Aleks's portfolio"
          >
            · By Aleks
            <ArrowUpRight size={12} strokeWidth={1.5} aria-hidden />
          </Link>
        </div>
        <div className="header__right site-header__actions">
          <nav className="site-header__nav" aria-label="Blog sections">
          ...
          <Drawer
            ...
            trigger={
              <DrawerTrigger
                ...
                className="site-header__nav-link site-header__index-trigger"
              >
                <span>Index</span>
              </DrawerTrigger>
            }
