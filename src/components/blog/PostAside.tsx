        ...
        <div className="top-header-height sticky ml-4 w-full max-w-64 pt-5 transition-opacity duration-500 xl:opacity-75 xl:group-hover:opacity-100">
          {nextInstalment && (
            <div className="mt-10 mb-6">
              <span className="kicker post-aside__serial-head">
                <SerialStar />
                Next instalment
              </span>
          ...
          {/* Label and list stand or fall together: the rail also renders
              for a lone next instalment, and the list's top hairline alone
              would print as a stray rule */}
          {posts.length > 0 && (
            <>
              <span
                className={
